...
class StartPage(Frame):
    def __init__(self, parent, controller):
        ...
        canvas = Canvas(self, height=700, width=800, bg='#7dabfa')
        canvas.grid(row=1, columnspan=3)

        frame = Frame(canvas, bg='#284f54')
        frame.place(relx=.09, rely=.25, relwidth=.77, relheight=.6)

        frame2 = Frame(canvas, bg='gray')
        frame2.place(relx=.9, rely=.85, relwidth=.10, relheight=.15)

        global i

        i = Image.open('job.jpg')

        if i.size != (80, 115):
            i = i.resize((80, 115), Image.ANTIALIAS)
        i = ImageTk.PhotoImage(i)
        labelf = Label(frame2, image=i)
        labelf.place(relwidth=1, relheight=1)
        ...
        canvas.create_line(650, 5, 800, 70, fill='#c5f6fc')  # create object to animate
        ...
        canvas.create_line(0, 285, 720, 630, fill='#c5f6fc')  # create object to animate
        canvas.create_line(0, 325, 720, 675, fill='#c5f6fc')  # create object to animate
        ...
        ball2 = canvas.create_oval(735, 150, 795, 230, tags='ball', fill='#703602')  # create object to animate
        t = canvas.create_text(110, 110, font=("Purisa"), text='Rover Views', fill='white')
        t2 = canvas.create_text(767, 190, text='welcome', fill='white')
        ...
        def animation2(bal, t, x_move, y_move):
            ...
            if k >= 200:
                labelf.grid_forget()
                my_lab = Label(frame2, image=I)
                my_lab.place(relwidth=1, relheight=1)
            if k>=250:
                return

            canvas.after(25, animation2, bal, t, x_move, y_move)
        ...
        global my_labe
        my_labe = Label(frame, image=mimagg1)
        my_labe.place(relx=.1,rely=.1,relwidth=.8, relheight=.8)
        ...
        def forward(image_number):
            ...
            my_labe.grid_forget()
            my_labe = Label(frame, image=image_list[image_number - 1])
...
class PageOne(Frame):
    def __init__(self, parent, controller):
        ...
        frame.place(rely=.15,relwidth=.5, relheight=.85)
        ...
        frame1.place(relwidth=.5, relheight=.14)

        frame2 = Frame(canvas, bg='#546770')
...
class PageTwo(Frame):
    def __init__(self, parent, controller):
        ...
        canvas = Canvas(self, height=700, width=800, bg='#50594e')
        canvas.grid(row=1,columnspan = 3)
        ...
        texts = Label(canvas, font=("Times","14","bold italic"), text = 'Click the image for informations about me', bg ='#79b0b5')
        ...
        def text():
            ...
            if x % 2 == 0:
                frame1.grid_forget()
                frame1 = Button(canvas, font=("Times","24","bold italic"),
        ...
        canvas.create_line(0,690,790,0 ,fill='red')
        canvas.create_line(0,691,791,0 ,fill='red')
        canvas.create_line(0,692,792,0 ,fill='red')
        canvas.create_line(0,693,793,0 ,fill='red')
        canvas.create_line(0,694,794,0 ,fill='red')
        canvas.create_line(0,695,795,0 ,fill='red')
        canvas.create_line(0,696,796,0 ,fill='red')
        canvas.create_line(0,697,797,0 ,fill='red')
        canvas.create_line(0,698,798,0 ,fill='red')
        canvas.create_line(0,699,799,0 ,fill='red')
        canvas.create_line(0,700,800,0 ,fill='red')
        canvas.create_line(1,700,800,1 ,fill='red')
        canvas.create_line(2,700,800,2 ,fill='red')
        ...
        R1 = canvas.create_rectangle(50, 50, 170, 170, tags='ball', fill='#1958a6')
        R2 = canvas.create_rectangle(50, 550, 170, 670, tags='ball', fill='#1958a6')
        R3 = canvas.create_rectangle(630, 48, 750, 170, tags='ball', fill='#1958a6')
        R4 = canvas.create_rectangle(630, 550, 750, 670, tags='ball', fill='#1958a6')
