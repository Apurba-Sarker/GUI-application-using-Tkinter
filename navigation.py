...
class StartPage(Frame):
    def __init__(self, parent, controller):
        ...
        page_one.grid(row=1,column=0)
        page_two = Button(self, text="Page Two", command=lambda:controller.show_frame(PageTwo))
        page_two.grid(row=2,column=0)

        canvas = Canvas(self, height=700, width=800, bg='green')
...
class PageOne(Frame):
    def __init__(self, parent, controller):
        ...
        start_page.grid(row=1,column=0)
        page_two = Button(self, text="Page Two", command=lambda: controller.show_frame(PageTwo))
        page_two.grid(row=2,column=0)
...
class PageTwo(Frame):
    def __init__(self, parent, controller):
        ...
        R1 = canvas.create_rectangle(50, 50, 170, 170, tags='ball', fill='black')
        R2 = canvas.create_rectangle(50, 550, 170, 670, tags='ball', fill='black')
        R3 = canvas.create_rectangle(630, 48, 750, 170, tags='ball', fill='black')
        R4 = canvas.create_rectangle(630, 550, 750, 670, tags='ball', fill='black')
